...
//    printf("Input mits - maximum solver iterations:\n");
    ...
    // Allocate memory for pre-calculated stuff
    ...
    // Copy pre-calculated stuff to the GPU
    double *d_fx_thing, *d_fy_thing;
    cudaMalloc(&d_fx_thing, n*sizeof(double));
    cudaMalloc(&d_fy_thing, m*sizeof(double));
    cudaMemcpy(d_fx_thing, fx_thing, n*sizeof(double), cudaMemcpyHostToDevice);
    cudaMemcpy(d_fy_thing, fy_thing, m*sizeof(double), cudaMemcpyHostToDevice);
